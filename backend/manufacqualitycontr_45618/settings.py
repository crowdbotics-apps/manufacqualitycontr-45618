"""
Django settings for manufacqualitycontr_45618 project.
...
ROOT_URLCONF = 'manufacqualitycontr_45618.urls'
...
WSGI_APPLICATION = 'manufacqualitycontr_45618.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manufacqualitycontr_45618 API",
    "DESCRIPTION": "API documentation for manufacqualitycontr_45618 App",
    "VERSION": "v1",
}
